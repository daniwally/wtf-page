...
// el nombre + la definición al pie. (archivo histórico SystemSection.jsx;
// ahora es "Infinity Engine")
...
const SystemSection = ({ id = "v3-engine" }) => {
  ...
  <ThemeSection theme={THEMES.night} id={id} className="flex flex-col overflow-hidden">
    ...
    <div className="relative z-10 flex-1 container mx-auto px-6 md:px-12 text-center flex flex-col items-center justify-center">
      ...
      <motion.p
        {...fadeUp}
        className="mb-8 w-full max-w-[min(88vw,1120px)] text-left font-hud text-[11px] md:text-xs tracking-[0.28em] uppercase text-volt"
      >
        {c.kicker}
      </motion.p>
    ...
    <div className="absolute inset-x-0 bottom-12 md:bottom-16 z-10 container mx-auto px-6 md:px-12">
      <p className="mx-auto max-w-5xl text-center text-[13px] md:text-[16px] font-light uppercase leading-relaxed text-cream/42">
        {definition}
      </p>
    </div>
  </ThemeSection>
